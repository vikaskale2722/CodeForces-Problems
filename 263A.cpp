...
// located in its middle (in the cell that is on the intersection of the third row and 
...
// the intersection of the i-th row and the j-th column. It is guaranteed that the matrix 
