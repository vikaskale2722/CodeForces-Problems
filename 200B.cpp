...
// (0 ≤ pi ≤ 100) — the volume fraction of orange juice in the i-th drink, in percent. 
// The numbers are separated by a space.

// Output
// Print the volume fraction in percent of orange juice in Vasya's cocktail. The answer 
// will be considered correct if the absolute or relative error does not exceed 10  - 4.
