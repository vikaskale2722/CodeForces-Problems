...
// not exceed h. If the height of some person is greater than h he can bend down and then 
// he surely won't be noticed by the guard. The height of the i-th person is equal to ai.
...
// would like to walk in a single row. What is the minimum width of the road, such that friends 
// can walk in a row and remain unattended by the guard?
...
// The second line contains n integers ai (1 ≤ ai ≤ 2h), the i-th of them is equal to the 
