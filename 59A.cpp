...
// register in every word so that it either only consisted of lowercase letters or, vice versa, only 
// of uppercase ones. At that as little as possible letters should be changed in the word. 
